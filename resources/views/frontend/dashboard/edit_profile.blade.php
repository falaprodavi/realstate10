...
<section class="page-title centred"
    style="background-image: url({{ (!empty($userData->photo)) ? url('upload/user_images/'.$userData->photo) : url('upload/no_image.jpg') }});">
                            ...
                            <div class="lower-content">
                                ...
                                <form method="POST" action="{{ route('user.profile.store') }}"
                                    ...
                                    <div class=" form-group">
                                        ...
                                        <img id="showImage" class="wd-90 rounded-circle" src="{{ (!empty($userData->photo))
