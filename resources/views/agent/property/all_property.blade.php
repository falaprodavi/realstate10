                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('agent.details.property', $item->id) }}"
                                                    class="btn btn-inverse-success" title="Details"> <i data-feather="eye"
                                                        style="width:15px;height: 15px;"></i> </a>

                                                <a href="{{ route('agent.edit.property', $item->id) }}"
                                                    class="btn btn-inverse-warning" title="Edit"> <i data-feather="edit"
                                                        style="width:15px;height: 15px;"></i> </a>

                                                <a href="{{ route('agent.delete.property', $item->id) }}"
                                                    class="btn btn-inverse-danger" id="delete" title="Delete"> <i
                                                        data-feather="trash-2" style="width:15px;height: 15px;"></i> </a>
