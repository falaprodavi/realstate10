                                ...
                                <div class="col-md-4 stretch-card grid-margin grid-margin-md-0">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h5 class="text-primary text-center mb-4">Up to 01 Property</h5>
                                            <table class="mx-auto">
                                                <tr>
                                                    <td><i data-feather="check" class="icon-md text-primary me-2"></i></td>
                                                    <td>
                                                        <p>Up to 01 Property</p>
                                                    </td>
                                                </tr>
                                ...
                                <div class="col-md-4 stretch-card grid-margin grid-margin-md-0">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h5 class="text-success text-center mb-4">Up to 03 Property</h5>
                                            <table class="mx-auto">
                                                <tr>
                                                    <td><i data-feather="check" class="icon-md text-primary me-2"></i></td>
                                                    <td>
                                                        <p>Up to 03 Property</p>
                                                    </td>
                                                </tr>
