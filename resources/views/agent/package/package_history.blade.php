                            ...
                            <table id="dataTableExample" class="table">
                                ...
                                <tbody>
                                    @foreach ($packagehistory as $key => $item)
                                        <tr>
                                            <td>{{ $item->id  }}</td>
                                            <td><img class="wd-90 rounded-circle"
                                            ...
                                            <td> <a href="{{ route('agent.package.invoice', $item->id) }}"
                                                    class="btn btn-inverse-warning" title="Download"> <i data-feather="download"
                                                        style="width:15px;height: 15px;"></i> </a> </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
